          ...
          <Flex direction='column' w='100%'>
              ...
              <>
                ...
                <Text fontSize='15px' mt='17px' mb='22px' px='25px' fontWeight='400' w='100%' h='auto'>
                  WFD Tokens will be used to operate WeFund Platforms. Projects convert 1% of their funding into WFD tokens.
                  WFD Tokens are also used as governance tokens for voting and governance of projects.
                </Text>
              </>}
          </Flex>
        </InputTransitiongrey>
        ...
        >
          <Flex direction='column' w='100%'>
              ...
              <>
                <Img mt='17px' mx='35px' height='1px' objectFit='cover' src='/media/line.svg' alt='UST Avatar'/>
                <Text fontSize='15px' mt='17px' mb='22px' px='25px' fontWeight='400' w='100%' h='auto'>
                  WFD Tokens will be used to operate WeFund Platforms. Projects for example converts 1% of their funding into WFD tokens.
                  WFD Tokens also used as governance tokens for voting and govern the project trajectory.
                </Text>
              </>}
          </Flex>
        </InputTransitiongrey>
        ...
        >
          <Flex direction='column' w='100%'>
              ...
              <>
                ...
                <Text fontSize='15px' mt='17px' mb='22px' px='25px' fontWeight='400' w='100%' h='auto'>
                  WFD Tokens will be used to operate WeFund Platforms. Projects for example converts 1% of their funding into WFD tokens.
                  WFD Tokens are also used as governance tokens for voting and governane of projects.
                </Text>
              </>}
          </Flex>
        </InputTransitiongrey>
