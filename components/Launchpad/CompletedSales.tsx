...
function SaleItem(props: {
  ...
  return (
    <Box
      ...
      background={
        selected
          ? "linear-gradient(90deg, rgba(38, 138, 255, 0.63) 0%, #2ABFFF 55.52%);"
          : "linear-gradient(90deg, #3F1780 0%, #0E0D5A 55.52%);"
      }
      padding={{ base: "9px", md: "18px" }}
      borderRadius={"18px"}
      borderStyle={"solid"}
      borderWidth={"3px"}
      borderColor={"#6ACEF5"}
        ...
        >
          ...
          <Hide below="md">
            <Box
              height={"120px"}
              width={"2px"}
              backgroundColor={selected ? "#430E82" : "#69E4FF"}
              marginX={"8px"}
            />
          </Hide>
          ...
          <Button
            ...
            textDecor={"inherit"}
            paddingX={"24px"}
            backgroundColor={selected ? "#0D1776" : "#0084FF"}
            color={"white"}
            fontWeight={"bold"}
          >
            RESEARCH
    ...
    <Box paddingY={"32px"} id="CompletedSales">
      <Container maxW={"container.xl"}>
        ...
        <Box
          borderRadius={"16px"}
          background={
            "linear-gradient(180deg, rgba(37, 5, 77, 0.48) 0%, rgba(69, 16, 138, 0.63) 100%);"
          }
          borderStyle={"solid"}
          borderWidth={"3px"}
          borderColor={"#6ACEF5"}
        ...
        >
          <Box padding={{ base: "8px", md: "30px" }}>
            <VStack spacing={"18px"}>
              {sales.map((sale, i) => (
                <SaleItem {...sale} selected={i === 0} key={i} />
              ))}
            </VStack>
          </Box>
        </Box>
