...
export default function Staking() {
  return (
    <Flex
      ...
      justify={"center"}
    >
      <Text fontSize={{ sm: "12px", md: "12px", lg: "24px" }} fontWeight="400">
      ...
      <Text
        ...
        w="60%"
      >
        Do you want to be best prepared for our platform launch? Choose your
        favorite faction and farm as many $WFD as you can!
      </Text>
      <HStack
        w="100%"
        justify={"center"}
