...
export default function Invest_step3() {
  ...
  //----------------upload signature----------------------------
  function openUpload() {
    if (typeof document !== 'undefined' && fileUploaderRef.current !== undefined) {
  ...
  function onChangeSignature(e) {
    if (typeof document !== 'undefined' && fileUploaderRef.current !== undefined) {
      var fileName = fileUploaderRef.current.value;
      ...
      reader.onload = function () {
        if (canvasRef.current) canvasRef.current.fromDataURL(reader.result);
      };
      ...
      >
        ...
        <Flex direction={{ base: 'column', md: 'column', lg: 'row' }} mt='40px' justify="center" align='center'>
          ...
          <Box align='center' ml={{ base: '0px', md: '0px', lg: '30px' }}>
            ...
            <Box>
              ...
              <Flex style={{ cursor: 'pointer' }} mt='20px' justify='left' fontSize='14px'>
                <ButtonTransition unitid="clear"
                  ...
                  onClick={() => { if (canvasRef.current) canvasRef.current.clear() }}
                >
                  <Box >Clear</Box>
                </ButtonTransition>
            ...
            <input type='file' id="fileSelector" ref={fileUploaderRef} name='userFile' style={{ display: 'none' }}
