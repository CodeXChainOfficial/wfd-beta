...
import {Box, Flex, Text,Table,Thead,Tbody,Tr,Th,Td,TableCaption, Image, HStack} from "@chakra-ui/react";
      ...
      >
        ...
        <Table variant='simple'>
          ...
          <Tbody bgColor={' rgba(196, 196, 196, 0.08)'} borderRadius={'10px 10px 0px 0px'}> 
            <Tr>
              ...
              <Td borderLeft={'1px solid rgba(255, 255, 255, 0.1)'} borderRight={'1px solid rgba(255, 255, 255, 0.1)'}>{investment.investAmount}</Td>
              <Td borderLeft={'1px solid rgba(255, 255, 255, 0.1)'} borderRight={'1px solid rgba(255, 255, 255, 0.1)'}>{investment.investWfdamount}</Td>
              <Td cursor='pointer'>
        ...
        <Table variant='simple'>
          ...
          <Tr>
            ...
            <Td bgColor={' rgba(196, 196, 196, 0.08)'} borderRadius={'0px 10px 0px 0px'} borderLeft={'1px solid rgba(255, 255, 255, 0.1)'}>{investment.investDate}</Td></Tr>
          <Tr>
            <Th bgColor={'rgba(255, 255, 255, 0.12)'} >UST <span style={{color:'#00A3FF'}}>You Invested</span></Th>
            <Td bgColor={' rgba(196, 196, 196, 0.08)'}  borderLeft={'1px solid rgba(255, 255, 255, 0.1)'}>{investment.investAmount}</Td>
          </Tr>
          <Tr>
            <Th bgColor={'rgba(255, 255, 255, 0.12)'} >WFD <span style={{color:'#00A3FF'}}>You will get</span></Th>
            <Td bgColor={' rgba(196, 196, 196, 0.08)'}  borderLeft={'1px solid rgba(255, 255, 255, 0.1)'}>{investment.investWfdamount}</Td>
